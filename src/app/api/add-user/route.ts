...
export async function GET(req: Request) {
  ...
  try {
    ...
    await db`INSERT INTO admins (user_id, username, email, password, role, current_balance, ranking) VALUES (${user_id}, ${username}, ${email}, ${password}, ${role}, ${current_balance}, ${ranking}) ON CONFLICT (user_id) DO NOTHING;`;
  } catch (error) {

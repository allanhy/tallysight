...
// Date formatting utility: Converts tomorrow's date to format like "Mon Jan 1 • 1:00 PM"
...
// Mock game data with dynamic dates - Used for development and testing
// Each game contains team information including name, spread, and logo path
const MOCK_GAMES = [
  {
    id: 1,
    date: formatGameDate(),
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-gray-900 p-4">
        <div className="inline-block bg-gray-800 rounded-lg p-2 text-white">
          ...
          <div className="text-sm text-gray-400">{formatWeekRange()}</div>
        </div>
      </div>
